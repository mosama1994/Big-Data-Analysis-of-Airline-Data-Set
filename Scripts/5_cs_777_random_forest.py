...
rf_full_data.to_csv(output_location + '/Random_Forest/Random_Forest_Full_Data_Metrics.csv', index=False)
rf_uni_data.to_csv(output_location + '/Random_Forest/Random_Forest_Uni_Data_Metrics.csv', index=False)
rf_var_data.to_csv(output_location + '/Random_Forest/Random_Forest_Var_Data_Metrics.csv', index=False)