...
lr_full_data_reg.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Regularization_Full_Data_Metrics.csv', index=False)
lr_uni_data_reg.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Regularization_Uni_Data_Metrics.csv', index=False)
lr_var_data_reg.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Regularization_Var_Data_Metrics.csv', index=False)
lr_full_data.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Full_Data_Metrics.csv', index=False)
lr_uni_data.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Uni_Data_Metrics.csv', index=False)
lr_var_data.to_csv(output_location + '/Logistic_Regression/Logistic_Regression_Var_Data_Metrics.csv', index=False)