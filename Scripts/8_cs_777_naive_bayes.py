...
nb_full_data.to_csv(output_location + '/Naive_Bayes/Naive_Bayes_Full_Data_Metrics.csv', index=False)
nb_uni_data.to_csv(output_location + '/Naive_Bayes/Naive_Bayes_Uni_Data_Metrics.csv', index=False)
nb_var_data.to_csv(output_location + '/Naive_Bayes/Naive_Bayes_Var_Data_Metrics.csv', index=False)